...
% Removed - don't have an example to include 
%
...
\Load FunInd.
\\ \\
Functional Scheme name\_ind := Induction for name Sort \ty{Prop}.
\end{code}
...
Can use \TT{rewrite \_ with \_} to specify how to interpret variables in the assumption.
~\\ \noindent
Example \ref{sum_to_n} demonstrates the use of arrows to give directionality to rewrite.  
~\\ \noindent
Examples \ref{sum_to_n} and \ref{sum_sq} demonstrate the use of \TT{rewrite \_ with \_}. 
